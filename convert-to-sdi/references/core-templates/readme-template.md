...
| [KNOWN_ISSUES.md](./KNOWN_ISSUES.md) | Append-only catalog of known bugs, security gaps, tech debt, and deferred fixes. |
| [DECISIONS.md](./DECISIONS.md) | Running paper trail of non-obvious choices. Seeded during onboarding when code evidence supports it, then appended during implementation. |
